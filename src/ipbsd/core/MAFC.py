...
class MAFC:
    def __init__(self, r, lam_target, gamma, Hs, sa_haz, omega, hazard):
        ...
        :param hazard: bool                         Hazard to use, i.e. True or Fitted (recommended: True)
        """
        self.cy = None                              # spectral acceleration at yield, [g]
        self.r = r
    ...
    def calc_mafe_direct_im_based(self, eta, beta):
        """
        Details:
    ...
    def objective(self, say):
        ...
        :param say: float                           Spectral acceleration at yield for an equivalent SDOF system
        ...
        if not self.hazard:
            # use the fitted hazard function
            ...
            # use the True hazard
            lam = self.calc_mafe_direct_im_based(mu_lnr, std_lnr)
            return self.lam_target - lam
